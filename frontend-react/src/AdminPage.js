  ...
  const fetchUsers = async () => {
    try {
      const res = await axios.get(
        "https://career-navigator-backend-96zi.onrender.com/api/candidates/all",
      );
      setUsers(res.data);
    } catch (e) {
      console.error(e);
      ...
      <div style={styles.tabContent}>
        <div style={styles.glassCardSecure}>
          <h2 style={styles.adminTitle}>
            <Lock size={22} color="#ef4444" /> Admin Authentication
          </h2>
          <form
    ...
    <div style={styles.tabContent}>
      <div style={styles.glassCard}>
        <div style={styles.tableHeaderRow}>
          ...
          >
            <Users size={22} color="#3b82f6" /> SVU Candidate Placement Matrix
          </h3>
          ...
          <tbody>
            {users.length > 0 ? (
              ...
              <tr>
                ...
                >
                  No candidate files parsed in database state.
                </td>
              </tr>
            )}
          </tbody>
